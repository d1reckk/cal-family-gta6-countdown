...
- "Análisis": un medio fiable interpreta material real y aporta contexto o conclusiones sustanciales.
...
Si el medio analiza material real y aporta observaciones concretas o contexto sustancial,
puede clasificarse como "Análisis".
...
bases de datos robadas o código fuente robado.

No descartes automáticamente una noticia porque mencione un leak histórico.
La pregunta principal es:
"¿La noticia necesita el material obtenido ilícitamente para sostener su afirmación principal?"

DUPLICADOS:
Compara el hecho central, no solamente el título.
Si aporta información sustancialmente nueva puede ser válida.
...
- Si no hay información suficiente, DESCARTAR.

DESCARTA:
- rumor sin respaldo;
- opinión pura;
- SEO/FAQ;
- recopilaciones superficiales;
...
DECISIÓN:
PUBLICAR solamente si score >= 75 y category != "Opinión".
